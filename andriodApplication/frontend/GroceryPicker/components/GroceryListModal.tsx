...
export const GroceryListModal = ({
  ...
  const { groceryListHistory, refreshVersion, setRefreshVersion } =
    useGroceryContext();
  ...
  useEffect(() => {
    ...
    const currentStatus = groceryListHistory.find(
      (list) => list.list_id === id,
    )?.list_status;
      ...
      req = [
        {
          list_id: id,
          list_status:
            currentListStatus === 'purchased' ? 'incomplete' : 'purchased',
        },
      ];
      ...
      req = [
        {
          list_id: id,
          list_status:
            currentListStatus === 'archived' ? 'incomplete' : 'archived',
        },
      ];
    } else {
